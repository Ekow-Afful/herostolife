...
const NavCardOne = () => {
  return (
    <div className="flex flex-col gap-3 w-1/2 border-[#88868633] border-[1px] rounded-[12px] p-3 sm:text-left text-center">
    ...
    <div className="flex w-full gap-2 justify-between items-start px-2">
      <div className="flex sm:flex-row flex-col w-1/2 justify-start items-center gap-2 group cursor-pointer">
